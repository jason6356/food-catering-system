...
public class ArrayList<T> implements ListInterface<T>, Serializable {
 ...
 numberOfEntries; numberOfEntries is array's numberOfEntries before removal.
  ...
  /**
   * Task : Extends the array if the array exceed the size of the array
   * Precondition : Array is not empty, numberOfEntries > array.length
   * Postcondition : Array has increase with the size of double the amount of the array
   * Returns : void
   */
  private void extendArray(){
    array = Arrays.copyOf(array, array.length + 1);
      //System.out.println("Array has resize with length of " + array.length);
  }
